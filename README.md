...
- `Classic Must-Read`：Transformer、RL、检索、生成模型、评估等跨方向基础论文。- `Agent Tool Use / Action Space`：Tool Use、Function Calling、API Calling、Code-as-Action、执行反馈、工具链组合与复杂任务执行。
